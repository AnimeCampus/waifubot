...
import sys
import traceback
from Hero import DEV_USERS, pbot
from pyrogram.errors import RPCError
import subprocess
from datetime import datetime
from pyrogram import filters, enums, Client as app
...
@app.on_message(filters.command(["run", "eval", "ex", "ev"]))
async def eval(client, message):
    ...
    final_output += f"<b>ᴛᴀᴋᴇɴ ᴛɪᴍᴇ</b>: {ping}<b>ms</b>"
